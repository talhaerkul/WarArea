...
public class NoxusDevriye2GUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NoxusDevriye2GUI frame = new NoxusDevriye2GUI(gamer,enemy,item);
	 ...
	 * Create the frame.
	 */
	public NoxusDevriye2GUI(Gamer gamer,Enemy enemy,Item item) {
		...
		btnNewButton.setBounds(46, 603, 98, 32);
		...
		textField.setBounds(938, 23, 250, 20);
		...
		textField_1.setBounds(1090, 47, 98, 20);
		...
		textField_2.setBounds(1090, 70, 98, 20);
		...
		textField_3.setBounds(1090, 94, 98, 20);
		...
		textField_4.setBounds(1090, 118, 98, 20);
		...
		textField_5.setBounds(1090, 141, 98, 20);
		...
		btnNewButton_1.setBounds(1090, 172, 98, 23);
		contentPane.add(btnNewButton_1);
		
		JLabel lblNewLabel = new JLabel(new ImageIcon(getClass().getResource("devriye2.jpg")));
